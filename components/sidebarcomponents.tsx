...
export const SidebarLink = ({
  ...
  return (
    ...
    >
      <div className="absolute  h-full w-full rounded-lg bg-gradient-to-r from-purple-500 to-blue-500 opacity-0 group-hover/sidebar:opacity-20 transition-opacity duration-200" />
