      ...
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 transition-all duration-300 lg:group-hover:-translate-y-10">
        {(() => {
          ...
          return (
            ...
            >
              <IconComp className="h-12 w-12 origin-left transform-gpu text-neutral-700 transition-all duration-300 ease-in-out group-hover:scale-75" />
            </motion.div>
          );
        })()}
        ...
        <p className="max-w-lg text-neutral-400 font-bitcount">{description}</p>
      </div>
...
export { default as default } from "./Bento";
